package com.jvidal.worksmarter.PDFReport.views;
...
import com.jvidal.worksmarter.PDFReport.views.basic.PDFVerticalView;
import com.jvidal.worksmarter.PDFReport.views.basic.PDFView;

import java.io.Serializable;

public class PDFTableView extends PDFView implements Serializable {
    private static final String TAG = "PDFTableView";
    private  PDFTableRowView headerRow, firstRow;
    private int[] rowWidthPercent = {15, 10, 45, 10, 20};
    ...
    public PDFTableView( Context context, PDFTableRowView headerRow) {
        super(context);
        this.headerRow = headerRow;
    ...
    public static class PDFTableRowView extends PDFHorizontalView implements Serializable {
         ...
         * @return current instance
         */
        public PDFTableRowView addTextRow(@NonNull PDFTextView TextViewToAdd) {
        ...
        public PDFTableRowView addImgeRow(@NonNull PDFImageView TextViewToAdd) {
            TextViewToAdd.setLayout(new LinearLayout.LayoutParams(
                    0,
                    ViewGroup.LayoutParams.WRAP_CONTENT, 1));
            super.addView(TextViewToAdd);
