package com.jvidal.worksmarter.PDFReport.activity;
...
import com.jvidal.worksmarter.PDFReport.custom.TouchImageViewFling;
import com.jvidal.worksmarter.PDFReport.custom.ViewPagerForPhotoView;
...
public class PDFViewerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new PDFViewerPagerAdapter(getSupportFragmentManager(), FragmentStatePagerAdapter.POSITION_NONE));
